...
parser.add_argument('--image_data_dir', type=str, default='./testing_set/image',
                    help='The directory containing the image data.')

parser.add_argument('--region_data_dir', type=str, default='./testing_set/region',
                    help='The directory containing the ground truth label data.')

parser.add_argument('--label_data_dir', type=str, default='./testing_set/groundtruth',
                    help='The directory containing the ground truth label data.')

parser.add_argument('--evaluation_data_list', type=str, default='./testing_set/testing.txt',
                    help='Path to the file listing the evaluation images.')

parser.add_argument('--model_dir', type=str, default='./Fusionlane_model',
...
def main(unused_argv):
  ...
  with tf.Session() as sess:
    ...
    saver.restore(sess, './Fusionlane_model/model.ckpt-Fusionlane')
