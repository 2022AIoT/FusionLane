...
flags.DEFINE_string('vis_logdir', './datasets/pascal_voc_seg/exp/train_on_train_set/vis', 'Where to write the event logs.')
# flags.DEFINE_string('vis_logdir', './datasets/pascal_voc_seg/exp/train_on_train_set/vis_new', 'Where to write the event logs.')

flags.DEFINE_string('checkpoint_dir', './datasets/pascal_voc_seg/exp/train_on_train_set/train', 'Directory of model checkpoints.')
#
...
flags.DEFINE_multi_float('eval_scales', [1.75],
...
# flags.DEFINE_string('dataset_dir', './datasets/pascal_voc_seg/my_tfrecord', 'Where the dataset reside.')
