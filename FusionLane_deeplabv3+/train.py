...
flags.DEFINE_string('train_logdir', './datasets/pascal_voc_seg/exp/train_on_train_set/train',
...
flags.DEFINE_integer('training_number_of_steps', 500,
...
flags.DEFINE_string('tf_initial_checkpoint', './deeplabv3_pascal_trainval/model.ckpt',
