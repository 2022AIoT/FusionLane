...
flags.DEFINE_string('eval_logdir', './datasets/pascal_voc_seg/exp/train_on_train_set/eval', 'Where to write the event logs.')
...
def main(unused_argv):
  ...
  with tf.Graph().as_default():
    ...
    indices = tf.squeeze(tf.where(tf.less_equal(labels, num_classes - 1)), 1)
